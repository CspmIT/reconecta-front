...
const HeaderBoard = () => {
	return (
		<div className='flex flex-row justify-center w-full'>
			<CardCustom className='w-5/6 min-h-28 border-l-[1rem] border-r-2 border-b-2 border-red-500  shadow-md !rounded-lg overflow-hidden p-5'>
				<div className='w-full flex md:flex-row p-3'>
					<div className='w-full md:w-1/3 grid items-center md:max-w-1/3 bg-slate-200 m-1'>
						<b className='w-full text-center'>Nombre</b>
						<p className='w-full text-center'>SETA </p>
					</div>
					<div className='w-full md:w-2/3 grid items-center md:max-w-2/3 bg-slate-200 m-1'>
				...
				<div className='w-full flex md:flex-row p-3'>
					...
					<div className='w-full md:w-1/3 grid items-center md:max-w-2/3 bg-slate-200 m-1'>
