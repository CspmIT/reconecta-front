		...
		<div className='flex flex-row justify-end w-full md:w-5/6 lg:w-2/6 pt-5'>
			<CardCustom className='w-full lg:w-11/12 min-h-28 border-l-[1rem] border-r-2 border-b-2 border-red-500  shadow-md !rounded-lg overflow-hidden p-5'>
				...
				<div className='w-full flex flex-wrap items-center justify-center p-3'>
					<div className='w-full grid items-center p-2 rounded-md bg-slate-200'>
					...
					<div className='w-full grid items-center p-2 rounded-md bg-slate-200 mt-2'>
...
export default InstantValuesBoard
