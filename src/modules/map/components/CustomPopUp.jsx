function CustomPopUp({ content }) {
	return (
		<div className='rounded-lg p-0 w-40 border-2 border-gray-900 overflow-hidden'>
			<div className='bg-slate-400 border-b-2 border-gray-900 p-2 row'>
			...
			<div className='bg-slate-800  text-green-400 pl-1 row items-center'>
				<p className='!m-0 font-bold  !mr-2 textoPopUp'>R</p>
				<p className='!m-0 w-full font-bold  text-end !mr-3 textoPopUp'>{content.VL1}</p>
				<p className='!m-0 font-bold  !mr-2 textoPopUp'>A</p>
			</div>
			<div className='bg-slate-800 text-green-400 border-y-2 border-gray-900 pl-1 row items-center'>
