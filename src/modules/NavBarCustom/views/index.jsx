        ...
        <div className="bg-white dark:bg-gray-800 h-full">
          ...
          <List>
            {menuSideBar.map((item, index) => {
              return (
                <Fragment key={index}>
                  <ListItem disablePadding sx={{ display: "block" }} onSelect={() => console.log("hola")}>
                    {item.submenus ? (
                      <SubMenuCustom item={item} className={`dark:text-white`} openSideBar={open} buttonActive={buttonActive} activeButton={activeButton} />
                    ) : (
